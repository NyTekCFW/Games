...
/*   Updated: 2024/07/26 20:59:44 by lchiva           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	__uint32_t  p_score[PLAYER_MAX];
	t_vec2		p_origin[PLAYER_MAX];
	t_vec4		p_box_rng[PLAYER_MAX];
	t_vec4		p_bbox_rng[PLAYER_MAX];
	clock_t		remaiming_time;
	t_vec2		b_origin;
	t_vec2		b_velocity;
	float		timescale;
	int			fps;
